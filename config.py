...
class Config(object):
    ...
    # Add support for depth and normal feature input
    USE_DEPTH = False
    USE_NORMALS = False
    # Compute depth/normal features in parallel with RGB in contrast with
    # simultaneously (i.e. create a bifurcated feature network). Non-parallel
    # means that the depth/normals will be concatenated with RGB *before* input
    # to the shared convolutional layers
