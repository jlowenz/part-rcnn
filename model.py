...
class MaskRCNN():
    ...
    def trivial_build(self):
        input_image = KL.Input(shape=config.IMAGE_SHAPE.tolist(), name="input_image")
        P2 = KL.Conv2D(256, (3, 3), padding="SAME", name="fpn_p2")(input_image)
        P3 = KL.Conv2D(256, (3, 3), padding="SAME", name="fpn_p3")(P2)                
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        self.loaded_weight_file_ = filepath
        if hasattr(f, 'close'):
            f.close()
    ...
    def train(self, train_dataset, val_dataset, learning_rate, total_epochs=0,
        ...
        layer_regex = {
            ...
            "3+": r"(res3.*)|(bn3.*)|(res4.*)|(bn4.*)|(res5.*)|(bn5.*)|" + heads,
            "4+": r"(res4.*)|(bn4.*)|(res5.*)|(bn5.*)|" + heads,
            "5+": r"(res5.*)|(bn5.*)|" + heads,
            # All layers
            "all": ".*",
        }
        ...
        # Data generators
        train_generator = DataGeneratorMP(train_dataset, self.config, augmentation=augmentation,
                                        batch_size=self.config.BATCH_SIZE)
        val_generator = DataGeneratorMP(val_dataset, self.config, augmentation=augmentation,
                                      batch_size=self.config.BATCH_SIZE)
    ...
    def detect(self, images, verbose=0):
        ...
        detections, mrcnn_class, mrcnn_bbox, mrcnn_mask, \
            rois, rpn_class, rpn_bbox = outs[:7]
        if cfg.enable_segmentation_extension:
            seg = outs[7]
        # Process detections
        results = []
